...
//		}
	...
	public static int MaxProfitTD(int[] wine, int i, int j, int year, int[][] dp) {
		// TODO Auto-generated method stub
		if (i > j) {
			return 0;
		}
		...
		int left = wine[i] * year + MaxProfitTD(wine, i + 1, j, year + 1, dp);
		int right = wine[j] * year + MaxProfitTD(wine, i, j - 1, year + 1, dp);
